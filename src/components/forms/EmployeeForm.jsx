      ...
      >
        <FormGroup>
          ...
          <Input
            ...
            value={
              this.state.department_id === null ? '' : this.state.department_id
            }
          >
            <option value=""></option>
        ...
        <FormGroup>
          ...
          <Input
            ...
            id="team_id"
            onChange={this.onChange}
            value={this.state.team_id === null ? '' : this.state.team_id}
          >
            <option value=""></option>
        ...
        <FormGroup>
          ...
          <Input
            ...
            id="emp_lname"
            onChange={this.onChange}
            value={this.state.emp_lname === null ? '' : this.state.emp_lname}
          />
        </FormGroup>
        <FormGroup>
          ...
          <Input
            ...
            id="emp_fname"
            onChange={this.onChange}
            value={this.state.emp_fname === null ? '' : this.state.emp_fname}
          />
        </FormGroup>
        <FormGroup>
          ...
          <Input
            ...
            onChange={this.onChange}
            value={
              this.state.emp_lname_kana === null
                ? ''
                : this.state.emp_lname_kana
            }
          />
        </FormGroup>
        <FormGroup>
          ...
          <Input
            ...
            onChange={this.onChange}
            value={
              this.state.emp_fname_kana === null
                ? ''
                : this.state.emp_fname_kana
            }
          />
        </FormGroup>
        <FormGroup>
          ...
          <FormGroup check>
            <Input
              ...
              onChange={this.onChange}
              checked={
                !this.state.gender || this.state.gender === '1' ? true : ''
              }
            />
            <Label check for="gender1">
              男
            </Label>
          </FormGroup>
          <FormGroup check>
            <Input
              ...
              value="2"
              onChange={this.onChange}
              checked={this.state.gender === '2' ? true : ''}
            />
            <Label check for="gender2">
              女
            </Label>
          </FormGroup>
        </FormGroup>
        ...
        <FormGroup>
          ...
          <Input
            ...
            id="emp_status"
            onChange={this.onChange}
            value={this.state.emp_status === null ? '' : this.state.emp_status}
          >
            <option value=""></option>
        ...
        <FormGroup>
          ...
          <Input
            ...
            onChange={this.onChange}
            value={
              this.state.mail_address === null ? '' : this.state.mail_address
            }
          />
        </FormGroup>
        <Button>確定</Button>
